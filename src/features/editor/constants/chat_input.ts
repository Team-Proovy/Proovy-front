...
export const CHAT_INPUT_CLASSES =
  "w-[660px] min-h-[160px] max-h-[270px] shrink-0 rounded-[12px] border-[0.5px] border-[#D1D6DE] bg-[rgba(255,255,255,0.40)] shadow-[4px_4px_20px_0px_rgba(0,0,0,0.05)] flex flex-col gap-[10px] p-[20px] relative";

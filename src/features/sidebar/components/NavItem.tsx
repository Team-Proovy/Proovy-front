  ...
  return (
    <NavLink
      ...
      className={({ isActive }) => {
        ...
        // active
        if (active) {
          return "relative z-10 flex h-[48px] w-[252px] cursor-pointer items-center gap-3 rounded-r-[12px] bg-white py-2 pr-3 pl-[20px] text-[22px] font-bold text-[#2F3440] shadow-[0_4px_10px_2px_rgba(0,0,0,0.10)] transition-all duration-300 ease-in-out";
        }
        // inactive

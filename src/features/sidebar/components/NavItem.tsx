  ...
  return (
    <NavLink
      ...
      className={({ isActive }) => {
        ...
        if (isActive) {
          if (isCollapsed) {
            return "relative z-10 flex h-[48px] w-[252px] cursor-pointer items-center gap-3 rounded-r-[12px] bg-transparent py-2 pr-3 pl-[20px] text-[#2A6AFF] transition-all";
          }
    ...
    >
      {({ isActive }) => (
        <>
          ...
          <span
            className={`overflow-hidden leading-[28px] tracking-[-0.01%] whitespace-nowrap transition-all duration-300 ease-in-out ${

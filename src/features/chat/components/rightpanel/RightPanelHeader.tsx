...
export const RightPanelHeader = ({
  ...
  return (
    <div className="relative flex h-[40px] w-full max-w-[720px] min-w-[270px] shrink-0 items-center justify-center rounded-b-[20px] border-[0.5px] border-[#D1D6DE] bg-white px-4">
